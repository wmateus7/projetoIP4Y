                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <select name="project_id" id="project_id" class="form-control">
                                    <option value="{{$task->project_id}}" selected>{{$projectsSelected->title}}</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" cols="4" value="{{ old('name', $task->description) }}" id="description" name="description">{{ old('name', $task->description) }}</textarea>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label for="status_id" class="font-bold mt-3">Status</label>

                                <select name="status_id" id="status_id" class="form-control">
                                    <option value="{{$statusSelected->id}}" selected>{{$statusSelected->description}}</option>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select name="user_id" id="user_id" class="form-control">
                                    <option value="{{$usersSelected->id}}"  selected>{{$usersSelected->name}}</option>
                            ...
                            <div class="col-md-4 col-sm-12">
                               ...
                               <input class="form-control mt-2" type="date" id="expiredDate" name="expiredDate" value="{{old('expiredDate', $task->expiredDate)}}"/>
                            </div>
                            <div class="col-12">
